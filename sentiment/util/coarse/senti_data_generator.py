...
class DataGenerator():
    def __init__(self,data_config,nn_config):
        ...
        self.test_attribute_ground_truth, self.test_sentiment_ground_truth ,self.test_sentence_ground_truth = self.load_test_data(self.aspect_dic,self.senti_dic,self.dictionary)
