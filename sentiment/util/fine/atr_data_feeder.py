...
class DataFeeder():
    ...
    def load_train_data(self):
        if os.path.exists(self.config['fine_train_data_file']) and os.path.getsize(self.config['fine_train_data_file']) > 0:
            with open(self.config['fine_train_data_file'],'rb') as f:
    ...
    def load_test_data(self):
        if os.path.exists(self.config['fine_test_data_file']) and os.path.getsize(self.config['fine_test_data_file']) > 0:
            with open(self.config['fine_test_data_file'],'rb') as f:
