...
class TransferTrain:
    ...
    def train(self,classifier, initializer_A_data,initializer_O_data):
        ...
        with graph.as_default():
            ...
            initializer_A = graph.get_collection('initializer_A')[0]
            initializer_O = graph.get_collection('initializer_O')[0]
            # train_step
        ...
        with graph.device('/gpu:1'):
            ...
            with tf.Session(graph=graph, config=config) as sess:
                sess.run(init, feed_dict={table: table_data, initializer_A:initializer_A_data,initializer_O:initializer_O_data})
