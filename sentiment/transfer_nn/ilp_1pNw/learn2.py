...
if __name__ == "__main__":
    ...
    reg_rate=[3E-5,]
    lr = [3E-4,]
    fine_nn_configs['reg_rage'] = reg_rate[args.num]
    fine_nn_configs['lr'] = lr[args.num]
    fine_nn_configs['tfb_filePath'] = '/datastore/liu121/sentidata2/resultdata/transfer/tfb/summ_'+str(args.num)
