    ...
    def classifier(self):
        ...
        with tf.variable_scope('attrExtr', reuse=tf.AUTO_REUSE):
            ...
            for i in range(self.nn_config['CoarseSenti_v2']['n_layers']):
                with tf.variable_scope('bilstm_layer_'+str(i)):
                    ...
                    pre_H = attr_H
                with tf.variable_scope('attr_mat_'+str(i)):
                    ...
                    A_e = A_e - o_e
                with tf.variable_scope('score_'+str(i)):
            ...
            #
            sentence_attention = tf.nn.softmax(score,)
            sentence_repr = ''
        ...
        with tf.variable_scope('sentiExtr', reuse= tf.AUTO_REUSE):
            ...
            tf.add_to_collection('attr_pred_labels_with_nonattr',attr_pred_labels)
