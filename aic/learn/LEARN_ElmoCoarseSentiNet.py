...
if __name__ == "__main__":
    ...
    config['attr_sr_path'] = '/datastore/liu121/sentidata2/result/elmo_nn_withKNattr/ckpt_reg%s_lr%s_mat%s_attr3/' \
                             % (str(reg_rate[args.num]), str(lr[args.num]), str(config['attribute_mat_size']))
    config['senti_sr_path'] = '/datastore/liu121/sentidata2/result/elmo_nn_withKNattr/ckpt_reg%s_lr%s_mat%s_senti/' \
                              % (str(reg_rate[args.num]), str(lr[args.num]), str(config['attribute_mat_size']))
    ...
    config['senti_is_restore'] = True
    config['report_filePath'] = '/datastore/liu121/sentidata2/report/elmo_nn_withKNattr/'
    main(config)