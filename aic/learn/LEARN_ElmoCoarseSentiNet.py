...
if __name__ == "__main__":
    ...
    config['senti_sr_path'] = '/datastore/liu121/sentidata2/result/elmo_nn/ckpt_reg%s_lr%s_mat%s_senti2/' \
                              % (str(reg_rate[args.num]), str(lr[args.num]), str(config['attribute_mat_size']))
    ...
    config['senti_initial_path'] = '/datastore/liu121/sentidata2/result/elmo_nn/ckpt_reg1e-05_lr0.001_mat5_senti/'
